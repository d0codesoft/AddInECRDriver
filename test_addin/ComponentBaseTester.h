		...
		try {
			...
			if (result) {
                if (methodGetVersion.value().countParams == 7) {
                    ...
                    descriptionDriver.append(L"Наименование: ");
                    descriptionDriver.append(getStringValue(params[0]));
                    descriptionDriver.append(L"\n");
                    descriptionDriver.append(L"Описание: ");
                    descriptionDriver.append(getStringValue(params[1]));
                    descriptionDriver.append(L"\n");
                    descriptionDriver.append(L"ТипОборудования: ");
                    descriptionDriver.append(equipmentType_);
                    descriptionDriver.append(L"\n");
                    descriptionDriver.append(L"РевизияИнтерфейса: ");
                    descriptionDriver.append(std::to_wstring(interfaceRevision_));
                    descriptionDriver.append(L"\n");
                    descriptionDriver.append(L"ИнтеграционнаяБиблиотека: ");
                    descriptionDriver.append(((isInterfaceRevision.value_or(false)) ? L"Да" : L"Нет"));
                    descriptionDriver.append(L"\n");
                    descriptionDriver.append(L"ОсновнойДрайверУстановлен: ");
                    descriptionDriver.append(((isMainDriver.value_or(false)) ? L"Да" : L"Нет"));
                    descriptionDriver.append(L"\n");
                    descriptionDriver.append(L"URLCкачивания: ");
