...
std::wstring str_utils_tools::to_wstring(const std::string& str, const std::string& encoding) {
#if defined(_WIN32)
	UINT codePage;
...
std::wstring str_utils_tools::to_wstring(const std::u16string& str)
{
	std::wstring result;
...
std::wstring str_utils_tools::to_wstring(const char* str, const std::string& encoding)
{
	if (!str)
		return {};
...
std::wstring str_utils_tools::to_wstring(const char16_t* str)
{
	if (!str) return {};
...
std::wstring str_utils_tools::to_wstring(const int value)
{
	return std::to_wstring(value);
}

std::wstring str_utils_tools::to_wstring(const size_t value)
{
	return std::to_wstring(value);
}

std::wstring str_utils_tools::to_wstring(const long value)
{
	return std::to_wstring(value);
}

std::u16string str_utils_tools::to_u16string(const std::string& str, const std::string& encoding)
{
	if (str.empty()) return {};
...
std::u16string str_utils_tools::to_u16string(const std::wstring& str)
{
...
std::u16string str_utils_tools::to_u16string(const char* str, const std::string& encoding)
{
	if (!str || !*str) return {};
...
std::u16string str_utils_tools::to_u16string(const wchar_t* str)
{
	std::u16string result;
...
std::u16string str_utils_tools::to_u16string(const char16_t* str)
{
	return std::u16string(str);
}

std::string str_utils_tools::to_string(const std::wstring& str)
{
	std::string result;
...
std::string str_utils_tools::to_string(const std::u16string& str)
{
	std::string result;
...
std::string str_utils_tools::to_string(const wchar_t* str)
{
	if (!str) return {};
...
std::string str_utils_tools::to_string(const char16_t* str)
{
	std::string result;
...
bool str_utils_tools::iequals(const std::wstring& a, const std::wstring& b) noexcept
{
#ifdef _WIN32
...
bool str_utils_tools::iequals(const std::string& a, const std::string& b) noexcept
{
	if (a.size() != b.size())
		return false;
...
std::optional<uint32_t> str_utils_tools::to_UInt(const std::wstring& value)
{
	// Trim whitespace
...
std::optional<double> str_utils_tools::to_Double(const std::wstring& value)
{
	try {
